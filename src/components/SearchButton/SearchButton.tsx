...
import { Coin, getSearchCriptomoedasService } from '../../services/getSearchCriptomoedasService';
...
export default function SearchButton(){
  ...
  useEffect(() => {
    if(debouncedSearch){
      getSearchCriptomoedasService(debouncedSearch).then((response) => setGetCoin(response.coins))
    }
  },[debouncedSearch]);
