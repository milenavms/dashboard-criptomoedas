      ...
      <DivDetailsCoin>
        <Grid container>
          <Grid item xs={12} md={9}>
            ...
            >
              <img
                src={error ? IconDefault : `${detailsCoin?.image.thumb}`}
                alt="icon default"
                className="iconCoin"
              />
            ...
            <Grid
              ...
              xs={12}
              md={12}
              sx={{ display: "flex", justifyContent: "left", marginTop: "8px" }}
            >
          ...
          <Grid item xs={12} md={3}>
            ...
            >
              <Typography
                variant="subtitle1"
                sx={{ color: theme.colors.gray200, fontWeight: "bold" }}
              >
                Preço de {error ? "moeda" : detailsCoin?.name} ({" "}
            ...
            >
              <Typography
                variant="subtitle1"
                sx={{ color: theme.colors.gray200, marginBottom: "0px" }}
              >
                R$ 0.00001392 BTC
              </Typography>
              <Typography
            ...
            >
              <Typography
                variant="subtitle1"
                sx={{ color: theme.colors.gray200 }}
              >
                R$ 0.00001973 ETH
              </Typography>
              <Typography
                variant="subtitle1"
                sx={{ color: theme.colors.green, marginRight: "12px" }}
              >
                2.94%
              </Typography>
            </Grid>
